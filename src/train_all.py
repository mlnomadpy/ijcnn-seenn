...
Description:
This Python script (train_all.py) is designed for training a multimodal classification model. 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--validation_views', type=str, required=True, help='Views used to filter out images from the training set.')
